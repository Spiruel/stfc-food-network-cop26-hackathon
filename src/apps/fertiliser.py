...
fertiliser_dic = {
        ...
        <br/>7. <i>Use NPK fertilisers with high N value.
        ...
        <br/>2. <i>Use only phosphorus-free fertiliser</i> – if you can limit the amount of phosphorous added to your soil, you can let the plants use the existing phosphorus while still providing other key nutrients such as Nitrogen and Potassium. Find a fertiliser with numbers such as 10-0-10, where the zero represents no phosphorous.
        ...
        <br/>3. <i>Phosphorus fertilisers</i> – applying a fertiliser with a high phosphorous content in the NPK ratio (example: 10-20-10, 20 being phosphorous percentage).
        ...
        <br/>8. If soil pH is low, add lime or potassium carbonate to the soil as fertilisers. Pure calcium carbonate is very effective in increasing the pH value of the soil.
        <br/>9. If pH is high, addition of appreciable amount of organic matter will help acidify the soil. Application of acidifying fertilisers, such as ammonium sulfate, can help lower soil pH""",
        ...
        <br/>5. Use NPK fertilisers with low K levels and organic fertilisers since they have low NPK values.
        ...
        <br/>5. Use Potash fertilisers since they contain high values potassium
        """
    }
