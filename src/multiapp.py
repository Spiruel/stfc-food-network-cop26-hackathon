...
class MultiApp:
    ...
    def run(self):
        ...
        st.sidebar.info(
            """
            This app uses Streamlit.
            Check out the project source code [here](https://github.com/spiruel/stfcfoodhackathon2021).
            """
        )
        st.sidebar.title("About")
        st.sidebar.info(
            """
            This app is maintained by [Samuel Bancroft](https://spiruel.github.io). You can follow me on social media:
             [GitHub](https://github.com/spiruel) | [Twitter](https://twitter.com/spiruel) | [LinkedIn](https://www.linkedin.com/in/samuel-bancroft)
            """
        )
